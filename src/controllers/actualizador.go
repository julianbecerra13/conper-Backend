...
func Actualizar(c *gin.Context) {
	...
	actualizadorRequest.IdCliente = c.Query("idCliente")
	...
	result := db.Raw("CALL spcp_sil_actualizar(?, ?, ?, ?, ?, ?, ?)", actualizadorRequest.IdPunto, actualizadorRequest.IdPedido, actualizadorRequest.IdCliente, actualizadorRequest.IdTraza, actualizadorRequest.IdAdicional, actualizadorRequest.Campo, actualizadorRequest.IdDomiciliario)
	if result.Error != nil {
